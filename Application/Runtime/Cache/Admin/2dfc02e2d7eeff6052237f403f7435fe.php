...
<div class="container-fluid">
	...
	<?php if(isset($success)): ?><div class="alert alert-success alert-block mssage"> <a class="close" data-dismiss="alert" href="#">×</a>
...
<div class="top-button">
	...
	<a href="<?php echo U('News/index',array('cid'=>$cid));?>" class="btn btn-primary">新闻列表</a>
	<a href="<?php echo U('Newcategory/add');?>" class="btn btn-primary">添加分类</a>
</div>

<!--
<?php if(isset($success)): ?><div class="mssage" style="font-size:14px;color:red;">添加成功。</div><?php endif; ?>
-->
...
<script type="text/javascript" charset="utf-8" src="/Public/ueditor/NewsUeditor/ueditor.config.js"></script>
<script type="text/javascript" charset="utf-8" src="/Public/ueditor/NewsUeditor/ueditor.all.js"> </script>
<script type="text/javascript" charset="utf-8" src="/Public/ueditor/NewsUeditor/lang/zh-cn/zh-cn.js"></script>
...
<script>
	...
	$("#newcategory").change(function(){
		var url = "<?php echo U('News/add',array('cid'=>'_ID_'));?>";
