	...
	<div class="row-fluid">
		<div class="span12">
			...
			<div class="top-button">
				选择banner分类：<select id="bannercategory">
				...
				<a href="<?php echo U('Banners/add',array('cid'=>$cid));?>" class="btn btn-primary">添加banner</a>
				<a href="<?php echo U('Bannercategory/add');?>" class="btn btn-primary">添加分类</a>
			</div>
			<!--分类 END-->
			...
			<div class="widget-box">
				...
				<div class="widget-content nopadding">
					<table class="table table-bordered table-striped">
						...
						<?php if(is_array($banners["data"])): foreach($banners["data"] as $key=>$v): ?><tr class="odd gradeX">
								<td>
									<img style="height:40px;" src="/Public/Uploads/banner/small/<?php echo ($v["thumb"]); ?>">
									<a style="width: 60px;height: 30px;display: inline-block" href="/Public/Uploads/banner/big/<?php echo ($v["thumb"]); ?>" class="tooltip">
									</a>
								</td>
								...
								<td>
									<?php if(empty($v["bannercategory_id"])): ?><a href="<?php echo U('Banners/index','cid=0');?>">未分类</a>
										<?php else: ?>
										<a href="<?php echo U('Banners/index',array('cid'=>$v['bannercategory_id']));?>"><?php echo ($v["bannercategory_name"]); ?></a><?php endif; ?>
								</td>
								...
								<a href="<?php echo U('Banners/edit',array('id'=>$v['id'],'cid'=>$v['bannercategory_id'],'p'=>$p));?>">修改</a>　
			...
			<div class="pagelist"><?php echo ($banners["pagelist"]); ?></div>
-->
			<div style="height:40px;">
				<ul class="pagination" style="float:right; margin:10px 0 0 0; ">
					<div style="height:40px;">
						<ul class="pagination" style="float:right; margin:10px 0 0 0; ">
							<?php echo ($banners["pagelist"]); ?>
						</ul>
					</div>
				</ul>
			</div>
...
<script>
    ...
    $("#bannercategory").change(function(){
        var url = "<?php echo U('Banners/index',array('cid'=>'_ID_'));?>";
    ...
    function change_status(obj,field){
        ...
        $("#form").attr("action","<?php echo U('Banners/change',array('p'=>$p,'cid'=>$cid));?>").submit();
    }
    //快捷操作-上架
    ...
    $(".act-del").click(function(){
        if(confirm('确定要删除吗？')){
            ...
            $("#form").attr("action","<?php echo U('Banners/del',array('p'=>$p,'cid'=>$cid));?>").submit();
        }
    });
</script>
