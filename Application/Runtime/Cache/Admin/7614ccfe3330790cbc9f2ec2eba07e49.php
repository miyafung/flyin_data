...
<script src="/Public/Admin/js/jquery.js"></script>
		<div id="content-header">
			<div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 网站配置</a> <a href="#" class="current">网站配置</a> </div>
			<h1>网站配置</h1>
		</div>
		...
		<div class="container-fluid">
			...
			<table class="table table-bordered table-striped table-responsive">
				<?php if(is_array($setup)): foreach($setup as $key=>$st): ?><tr>
					...
					<tr>
						<th>联系人:</th>
						<td><?php echo ($st["linkman"]); ?></td>
					</tr>
					<tr>
						<th>手机:</th>
						<td><?php echo ($st["cellphone"]); ?></td>
					</tr>
					<tr>
						<th>电话:</th>
						<td><?php echo ($st["tel"]); ?></td>
					</tr>
					<tr>
						<th>传真:</th>
						<td><?php echo ($st["fax"]); ?></td>
					</tr>
					<tr>
						<th>QQ:</th>
						<td><?php echo ($st["qq"]); ?></td>
					</tr>
					<tr>
						<th>邮件:</th>
						<td><?php echo ($st["mail"]); ?></td>
					</tr>
					...
					<tr>
						<th>网站版权 :</th>
						<td><?php echo ($st["copy"]); ?></td>
					</tr>
					<tr style="background: yellow;height: 50px;width:100px;" >
						<th>网站Logo :</th>
						<td><img src="/Public/Common/Uploads/Photos/<?php echo ($st["logo"]); ?>" style="width: 80px"/></td>
					</tr>
					<tr>
						<th>网站关键字 :</th>
						<td><?php echo ($st["keywords"]); ?></td>
					</tr>
					<tr>
						<th>网站描述 :</th>
					...
					<tr>
						<th>今日搜索 :</th>
						<td><?php echo ($st["hotsearch"]); ?></td>
					</tr>
					<tr>
						<th>网站作者 :</th>
						<td><?php echo ($st["author"]); ?></td>
					</tr>
					<tr>
						<th>是否启用 :</th>
					...
					<tr>
						...
						<td  style="line-height:50px;" colspan="4">
							<!--<a href="/Admin/WebSet/updWebSet/id/<?php echo ($st["id"]); ?>" class="btn btn-primary">修改</a>-->
							<a href="/Admin/WebSet/updWebSet/id/<?php echo ($st["id"]); ?>" class="btn btn-primary" style="text-decoration:none;margin-left:20px;">修改</a> | <a href="/Admin/WebSet/delWebSet/id/<?php echo ($st["id"]); ?>" class="btn btn-primary" style="text-decoration:none;">删除</a> |
							<a href="/Admin/WebSet/addWebSet" class="btn btn-primary" hidden>添加配置</a>
						</td>
					</tr><?php endforeach; endif; ?>

			</table>

						<a class="btn btn-primary" href="<?php echo U('WebSet/clearRuntime');?>">清除网站缓存runtime</a>
