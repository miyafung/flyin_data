...
<script src="/Public/Admin/js/jquery.js"></script>
		<div id="content-header">
			<div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 关于我们</a> <a href="#" class="current">关于我们</a> </div>
			<h1>关于我们</h1>
		</div>
		...
		<div class="container-fluid">
			...
			<table class="table table-bordered table-striped table-responsive">
				<?php if(is_array($setup)): foreach($setup as $key=>$st): ?><tr>
						<th>优势 :</th>
						<td><?php echo ($st["profile"]); ?></td>
					</tr>
					<tr>
						<th>文化 :</th>
						<td><?php echo ($st["culture"]); ?></td>
					</tr>
					<tr style="background: yellow;height: 50px;width:100px;" >
						<th>证书:</th>
						<td><img src="/Public/Common/Uploads/Certification/<?php echo ($st["certification"]); ?>" style="width: 400px"/></td>
					</tr>
					<tr>
						<th>是否启用 :</th>
					...
					<tr>
						...
						<td  style="line-height:50px;" colspan="4">
							<!--<a href="/Admin/AboutUs/updWebSet/id/<?php echo ($st["id"]); ?>" class="btn btn-primary">修改</a>-->
							<a href="/Admin/AboutUs/updAboutUs/id/<?php echo ($st["id"]); ?>" class="btn btn-primary" style="text-decoration:none;margin-left:20px;">修改</a> | <a href="/Admin/AboutUs/delAboutUs/id/<?php echo ($st["id"]); ?>" class="btn btn-primary" style="text-decoration:none;">删除</a>

						<!--	<a href="/Admin/AboutUs/addAboutUs" class="btn btn-primary" hidden>添加配置</a>-->
						</td>
