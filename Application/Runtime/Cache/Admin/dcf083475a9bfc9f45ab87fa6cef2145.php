    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <div>
                ...
                <h5>产品总数： <?php echo ($goodsCount); ?> 。</h5>
            </div>
            ...
            <div>
                <table class="table table-bordered table-hover table-striped">
                    ...
                    <?php if(is_array($goodssearch)): $i = 0; $__LIST__ = $goodssearch;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td><?php echo ($vo["goods_id"]); ?></td>
                            <td><?php if(!empty($vo["img_small"])): ?><img src="/Public/Uploads/products/small/<?php echo ($vo["img_small"]); ?>" /><?php endif; ?></td>
                            <td><?php echo ($vo["goods_name"]); ?></td>

                            <td>
                                <!--判断该$vo.hits 是否大于等于9999-->
                                <?php if($vo["hits"] >= '10'): ?>99999+
