...
<div id="content-header">
	<div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> banner</a> <a href="#" class="current">服务添加</a> </div>
	<h1>服务添加</h1>
</div>
...
<div class="top-button">
	...
	<a href="<?php echo U('Services/index',array('cid'=>$cid));?>" class="btn btn-primary">banner列表</a>
...
<div class="list auto">
	<form method="post" enctype="multipart/form-data">
		<table class="t2 t4">
			<tr><th>banner名称：</th><td><input type="text" name="name" class="big"></td></tr>
		...
		<div class="editor">
			<script type="text/javascript" charset="utf-8" src="/Public/ueditor/ServicesUeditor/ueditor.config.js"></script>
<script type="text/javascript" charset="utf-8" src="/Public/ueditor/ServicesUeditor/ueditor.all.js"> </script>
<script type="text/javascript" charset="utf-8" src="/Public/ueditor/ServicesUeditor/lang/zh-cn/zh-cn.js"></script>
...
<script type="text/javascript">
    ...
    UE.getEditor('myEditor',{
     ...
     //   "imageUrl":"<?php echo U('Services/uploadImage');?>", //图片上传提交地址
     //   "imagePath":"/Public/Uploads/service/desc/"  //图片显示地址
    });

</script>

			<script type="text/plain" id="myEditor" name="desc"><p>请在此处输入技术支持详情。</p></script>
		</div>
		<div style="margin-top: 20px">
			<input class="btn btn-primary" type="submit" value="添加Services">
...
<script>
    ...
    $("#category").change(function(){
        var url = "<?php echo U('Services/add',array('cid'=>'_ID_'));?>";
