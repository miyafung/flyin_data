...
<!--main-container-part-->
<div id="content">
    <div class="item"><link rel="stylesheet" href="/Public/Admin/css/admin.css"> <!--百度地图样式-->
...
<div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>百度地图</a> <a href="#" class="current">百度地图</a> </div>
    <h1>百度地图</h1>
</div>
<!-- 面包屑 END -->
