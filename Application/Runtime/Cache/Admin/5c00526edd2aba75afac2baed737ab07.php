...
<div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 关键词</a> <a href="#" class="current">关键词</a> </div>
    <h1>全站搜索关键词记录</h1>
</div>
    ...
    <div class="row-fluid">
        <div class="span12">
            <table class="table table-bordered table-hover">
                ...
                <?php if(is_array($Searchkeywordres)): $k = 0; $__LIST__ = $Searchkeywordres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                        <td align="center"><?php echo ($k); ?></td>
                        <td align="center"><?php echo ($vo["keywords"]); ?></td>
                        <td align="center"><?php echo ($vo["hits"]); ?></td>
                        <td align="center">
                            <a href="<?php echo U('Goods/delkeyword',array('keyword_id'=>$vo['keyword_id']));?>" class="btn btn-danger btn-sm shiny">
