...
<div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 访客日志</a> <a href="#" class="current">访客日志</a> </div>
    <h1>访客日志</h1>
</div>
...
<div class="container-fluid">
    <ul class="stat-boxes2">
        <li>
            <div class="right"> 总数<strong><?php echo ($count); ?></strong> </div>
        </li>
        <li>
            <div class="right"> Hot!<strong></strong> </div>
        </li>
    </ul>
    <ul class="stat-boxes2">
        <li>
            <div class="right">
                ...
                <form action="" method="post">
                    ...
                    <a href=""  class="btn btn-primary btn-lg">返回列表</a>
                </form>
    ...
    <div class="row-fluid">
        ...
        <!--Data Table-->
         <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php if(is_array($dataip)): $i = 0; $__LIST__ = $dataip;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td><a href="#" class="btn-link"><?php echo ($vo["ip"]); ?></a></td>
                            <td><?php echo ($vo["country"]); ?></td>
                            <td><?php echo ($vo["district"]); ?></td>
                            <td><?php echo ($vo["isp"]); ?></td>
                            <td><span class="text-muted"><i class="fa fa-clock-o"></i><?php echo ($vo["current_date"]); ?></span></td>
