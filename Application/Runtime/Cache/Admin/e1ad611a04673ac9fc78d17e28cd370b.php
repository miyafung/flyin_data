...
<div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 网站留言</a> <a href="#" class="current"> 网站留言</a> </div>
    <h1> 网站留言</h1>
</div>
        ...
        <div class="span12">
            ...
            <table class="table table-bordered table-striped">
                ...
                <?php if(is_array($dataip)): $i = 0; $__LIST__ = $dataip;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo ($vo["email_adress"]); ?></td>
                        <td><?php echo ($vo["message"]); ?></td>
                        <td><?php echo ($vo["current_time"]); ?></td>
