...
<!--main-container-part-->
<div id="content">
    <div class="item"><div class="title">product分类添加</div>
<div class="top-button">
	相关操作：<a href="<?php echo U('Productcategory/index');?>" class="light">product分类列表</a>
</div>
...
<div class="list auto">
	<form method="post">
		<table class="t2 t3">
			<tr><th>上级分类：</th><td>
				<select name="pid" id="productcategory">
					<option value="0">顶级分类</option>
					<?php if(is_array($productcategory)): foreach($productcategory as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo str_repeat('— ',$v['level']); echo ($v["name"]); ?></option><?php endforeach; endif; ?>
				</select>
			</td></tr>
...
<?php if(isset($pid)): ?><script> $("#productcategory").val(<?php echo ($pid); ?>); </script><?php endif; ?></div>
