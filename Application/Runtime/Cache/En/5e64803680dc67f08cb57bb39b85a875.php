             ...
             <h3>PDF -- Alphabetical order</h3>
                        <table class="table table-bordered table-striped">
                                ...
                                <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr>
                                        <td><?php echo ($k); ?> </td>
                                        <td>
                                            <?php if(is_array($vo)): $i = 0; $__LIST__ = $vo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><a href=" /Public/Uploads/pdf/<?php echo ($v); ?>" target="_blank">
                                               <?php echo ($v); ?><br>
