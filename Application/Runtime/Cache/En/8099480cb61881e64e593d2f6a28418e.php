...
<section id="listing1" class="listing1 padding_top">
    <div class="container">
        ...
        <h3>PDF速查</h3>
            <!--商品分类-->
            <a href="<?php echo U('Pdf/orderByName');?>" class="btn btn-primary" style="margin-right: 20px;">Sort by alphabetical order</a>
                <form action="" method="post">
                    <input type="search" name="keywords"  placeholder="请输入PDF文档名字..." class="keyword-input"/>
                            ...
                            <?php if(is_array($pdfsearch)): foreach($pdfsearch as $key=>$lk): ?><tr>
                                    ...
                                    <td style="text-align: center;font-size: 14px">
                                        ...
                                        <script>
                                            ...
                                            ajax.open('GET','/En/Pdf/downloadFile/<?php echo ($_GET['goods_id']); ?>',true);
                                            ajax.send();
                                        </script>
