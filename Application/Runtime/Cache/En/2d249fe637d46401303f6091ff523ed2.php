...
<div class="container" style="margin-top: 100px;">
    <div class="row">
        <!-- News Start -->
        <div class="col-md-12" >
            Matching information number：<span id="allsore"></span></a></li>
            <ul id="myTab" class="nav nav-tabs">
                <li class="active"><a href="#goods_list" data-toggle="tab">Products <span id="goodssore"></span></a></li>
                <li><a href="#news_list" data-toggle="tab">News <span id="newssore"></span></a></li>
                <li><a href="#service_list" data-toggle="tab">Service support<span id="servicesore"></span></a></li>
            </ul>
                    ...
                    <section class="property-details">
                        <div class="container property-details">
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="row">
                                        <?php if(empty($goodssearch)): ?><div class="empty-tip">There is no information you need.</div>
                                            <?php else: ?>
                                            <ul class="br2">
                                                    ...
                                                    <div class="col-md-10 col-sm-10 col-xs-12 padding-left-25">
                                                        ...
                                                        <div class="pro-3-link padding-t-20">
                                                            <a class="btn-more" href="<?php echo U('Category/view?cat_id=' . $vo['cat_id']);?>" target="_blank">
                                                                <i><img alt="arrow" src="/Public/Home/images/arrowl.png"></i><span>来自：【Products】<?php echo ($vo["cat_name"]); ?></span><i> <img alt="arrow" src="/Public/Home/images/arrowr.png"></i>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <section class="property-details">
                        <div class="container property-details">
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="row">
                                        <?php if(empty($newssearch)): ?><div class="empty-tip">There is no information you need.</div>
                                            <?php else: ?>
                                            <ul class="xinwen">
                                                            ...
                                                            <div class="col-md-10 col-sm-10 col-xs-12 padding-left-25">
                                                                ...
                                                                <div class="pro-3-link padding-t-20">
                                                                    <a class="btn-more" href="<?php echo U('News/index',array('cid'=>$newvo['newcategory_id'],'id'=>$newvo['id']));?>" target="_blank">
                                                                        <i><img alt="arrow" src="/Public/Home/images/arrowl.png"></i><span>类目：【News】<?php echo ($newvo["newcategory_id"]); ?></span><i> <img alt="arrow" src="/Public/Home/images/arrowr.png"></i>
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        </div>
