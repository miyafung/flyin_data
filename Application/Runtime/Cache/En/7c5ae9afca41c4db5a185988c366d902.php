    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h1 class="text-uppercase">News Center</h1>
                <p>Here you can learn the company's movements and latest information</p>
...
<section id="news-section-1" class="property-details padding_top">
    <div class="container property-details">
        <div class="row">
            <div class="col-md-8">
                <div class="row">
                    <?php if(empty($news["data"])): ?><div class="empty-tip">There is no information you need.</div>
                        <?php else: ?>
                    <?php if(is_array($news["data"])): foreach($news["data"] as $key=>$v): ?><div class="news-1-box clearfix">
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12 padding-left-25">
                                ...
                                <div class="news-details padding-b-10 margin-t-5">
                                    <span><i class="fa fa-user-o" aria-hidden="true"></i>by flyindata</span>
                                ...
                                <div class="pro-3-link padding-t-20">
                                    <a class="btn-more" href="<?php echo U('News/news',array('id'=>$v['id']));?>" target="_blank">
                                        <i><img alt="arrow" src="/Public/Home/images/arrowl.png"></i><span>more</span><i> <img alt="arrow" src="/Public/Home/images/arrowr.png"></i>
                                    </a>
                                </div>
                            </div>
            ...
            <aside class="col-md-4 col-xs-12">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <!-- 导航 START -->
	<h3 class="bottom20">News category</h3>
