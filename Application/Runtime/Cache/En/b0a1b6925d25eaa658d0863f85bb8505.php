    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h1 class="text-uppercase">service support</h1>
                <p>Here you can learn about the company's service support program</p>
...
<section id="news-section-1" class="property-details padding_top">
    <div class="container property-details">
        <div class="row">
            <div class="col-md-8">
                <div class="row">
                    <?php if(empty($services["data"])): ?><div class="empty-tip">There is no information you need.</div>
                        <?php else: ?>
                        <?php if(is_array($services["data"])): foreach($services["data"] as $key=>$v): ?><div class="news-1-box clearfix">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 padding-left-25">
                                    ...
                                    <div class="news-details padding-b-10 margin-t-5">
                                        ...
                                        <span><i class="fa fa-user-o" aria-hidden="true"></i>flyindata</span>
...
<!-- 导航 START -->
<h3 class="bottom20">Service Support Category</h3>
