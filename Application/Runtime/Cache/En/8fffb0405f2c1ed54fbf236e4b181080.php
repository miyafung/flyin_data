...
<section id="news-section-1" class="property-details padding_top" >
    <div class="container property-details" style="margin-top: 20px;">
        <div class="row">
            <div class="col-md-8">
                <div class="row">
                    <?php if(empty($goodsList["data"])): ?><div class="empty-tip">Not finding the product information you need.</div>
                        <?php else: ?>
                    <?php if(is_array($goodsList["data"])): $i = 0; $__LIST__ = $goodsList["data"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-sm-6">
                            <div class="property_item heading_space">
                                <div class="image">
                                    <a href="#.">
                                        <img style="height: 249px;" src="<?php if(!empty($vo["img_center"])): ?>/Public/Uploads/products/center/<?php echo ($vo["img_center"]); endif; ?>" alt="<?php echo ($vo["goods_name"]); ?>" class="img-responsive">
                                    </a>
                                    <div class="price clearfix">
                                        <span class="tag pull-right">view：<?php echo ($vo["hits"]); ?></span>
                                    </div>
                                </div>
                                    ...
                                    <div class="proerty_text">
                                        <h5 class="captlize">
                                            <a href="<?php echo U('Goods/view?cat_id=' . $vo['cat_id'] . '&goods_id=' . $vo['goods_id']);?>" target="_blank" data-toggle="tooltip" data-placement="right" title="<?php echo ($vo["goods_name"]); ?>">
                                                <script>document.write(csubstr2("<?php echo ($vo["goods_name"]); ?>",50));</script>
                                            </a>
                                        </h5>
                                    </div>
            ...
            <aside class="col-md-4 col-xs-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <!-- 产品导航 START -->
                        <h3 class="bottom20"> Product Catalog</h3>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h5 class="bottom40 margin40">History</h5>
                    </div>
                </div>
                <?php if(is_array($historyen)): $i = 0; $__LIST__ = array_slice($historyen,0,5,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><!--循环出 1-5个 第6个不显示，是以 ul    li  结构构成-->
