...
<div class="container" >
    ...
    <div class="row">
    <!--
当前位置：<?php if(is_array($path)): foreach($path as $key=>$v): ?>&nbsp;<a
            href="<?php echo U('News/index',array('cid'=>$v['id']));?>"><?php echo ($v["name"]); ?></a>&nbsp;&gt;<?php endforeach; endif; ?>&nbsp;<?php echo ($news["name"]); ?>
-->
        <ol class="breadcrumb">
        ...
        <div class="center"> <h5><?php echo ($news["name"]); ?></h5></div>
        <div class="center"><?php echo ($news["custom_time"]); ?></div>
        <div class=""></div><?php echo ($news["desc"]); ?>
