    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h1 class="text-uppercase">服务支持</h1>
                <p>在这里你可以了解到公司的动向和最新信息</p>


                <ol class="breadcrumb text-center">
                    <li><a href="<?php echo U('Home/index');?>">Home</a></li>
                    <li><a href="<?php echo U('Services/index');?>">Services</a></li>
                    <?php if(is_array($path)): foreach($path as $key=>$v): ?><li> <a href="<?php echo U('Services/index',array('cid'=>$v['id']));?>"><?php echo ($v["name"]); ?></a></li><?php endforeach; endif; ?>&nbsp;
                </ol>
            </div>
        </div>
    </div>
...
<section id="news-section-1" class="property-details padding_top">
    <div class="container property-details">
        <div class="row">
            <div class="col-md-8">
                <div class="row">
                    <?php if(empty($services["data"])): ?><div class="empty-tip">没有找到您需要的信息。</div>
                        <?php else: ?>
                        <?php if(is_array($services["data"])): foreach($services["data"] as $key=>$v): ?><div class="news-1-box clearfix">
                                <!--
                                <div class="col-md-5 col-sm-5 col-xs-12">
                                    <div class="image-2">
                                        <a href=""> <img src="/Public/Uploads/services/small/<?php echo ($v["thumb"]); ?>" alt="image"  class="img-responsive"></a>
                                    </div>
                                </div>
                                -->
                                <div class="col-md-12 col-sm-12 col-xs-12 padding-left-25">
                                    <h4><a href="<?php echo U('Services/services',array('id'=>$v['id']));?>" target="_blank"> <script>document.write(csubstr("<?php echo ($v["name"]); ?>",150));</script></a></h4>
                                    <div class="news-details padding-b-10 margin-t-5">
                                      <!--  <span><i class="icon-icons230"></i> by Martin Moore</span>-->
                                        ...
                                        <span><i class="icon-icons228"></i><?php echo ($v["date"]); ?></span>
                                    </div>
                                    <p class="p-font-15">
                                        <script>document.write(csubstr("<?php echo ($v["desc"]); ?>",120));</script>
                                    </p>

                                    <div class="pro-3-link padding-t-20">
                                        <a class="btn-more" href="<?php echo U('Services/services',array('id'=>$v['id']));?>" target="_blank">
...
<!-- 导航 START -->
<h3 class="bottom20">服务支持</h3>
<ul class="pro-list bottom20">
	<?php if(is_array($servicecategory)): $i = 0; $__LIST__ = array_slice($servicecategory,0,20,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i;?><li>
		<a href="<?php echo U('Services/index',array('cid'=>$v1['id']));?>"><?php echo ($v1["name"]); ?></a>
		</li>
		<ul>
			<?php if(isset($v1["child"])): if(is_array($v1["child"])): foreach($v1["child"] as $key=>$v2): ?><a href="<?php echo U('Services/index',array('cid'=>$v2['id']));?>"><?php echo ($v2["name"]); ?></a><?php endforeach; endif; endif; ?>
...
<!-- 导航 END -->
                    ...
                    <div class="col-md-12">
                        <div class="widget" id="widget_statistics">
                            ...
                            <div style="height:110px;overflow:auto;">
                                <ul>
                                    <?php if(is_array($servicesgui)): $i = 0; $__LIST__ = $servicesgui;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li title="<?php echo ($vo["t"]); ?>(<?php echo ($vo["num"]); ?>篇)"><a href=""><?php echo ($vo["t"]); ?>(<?php echo ($vo["num"]); ?>篇)</a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-4 col-xs-12 p-image image bottom20">
                        <img src="/Public/Home/images/f-p-1.png" alt="image">
                    </div>
                ...
                <div class="row padding-b-30 padding-t-30">
                    <div class="col-md-4 col-sm-4 col-xs-12 p-image image bottom20">
                        <img src="/Public/Home1/images/f-p-1.png" alt="image">
                    </div>
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <div class="feature-p-text">
                            <h4><a href="#.">Get the best property in Town by our agent</a></h4>
                        ...
                        <div id="agent-2-slider" class="owl-carousel">
                            <div class="item">
                                <div class="property_item heading_space">
                                    <div class="image">
                                        <a href="#."><img src="/Public/Home/images/slider-list2.jpg" alt="listin" class="img-responsive"></a>
