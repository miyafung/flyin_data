...
<section id="listing1" class="listing1 padding_top">
 -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3 class="text-uppercase">PDF速查</h3>
                 <!--商品分类-->
                            ...
                            <?php if(is_array($pdfsearch)): foreach($pdfsearch as $key=>$lk): ?><tr>
                                    ...
                                    <td>
                                        <a href=" /Public/Uploads/pdf/<?php echo ($lk["goods_pdf"]); ?>" target="_blank">
                                           <i class="fa fa-file-pdf-o"></i> <?php echo ($lk["goods_pdf"]); ?>
                                         </a>
                                    </td>
                                    <!--
                                    ...
                                    <td style="text-align: center;font-size: 14px">
                                        <a href="<?php echo U('Pdf/downloadFile',array('goods_id'=>$lk['goods_id']));?>"><i class="fa fa-download"></i> (<?php echo ($lk["pdfhits"]); ?>)</a>
                                        <!-- 下载次数 -->
                                        <script>
                                            var ajax;
                                            if(window.XMLHttpRequest){ ajax = new XMLHttpRequest();}else{ ajax = new ActiveXObject('Microsoft.XMLHTTP');}
                                            ajax.open('GET','/Home/Pdf/downloadFile/<?php echo ($_GET['goods_id']); ?>',true);
                                            ajax.send();
                                        </script>
                                    </td>
