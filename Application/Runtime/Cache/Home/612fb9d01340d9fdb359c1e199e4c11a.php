...
<div class="container" >
    ...
    <div class="row">
        ...
        <div class="center" style="text-align: center"> <h5><?php echo ($services["name"]); ?></h5></div>
        <div class="center"  style="text-align: center"><?php echo ($services["date"]); ?></div>
        <div class=""><?php echo ($services["desc"]); ?></div>
</div>
