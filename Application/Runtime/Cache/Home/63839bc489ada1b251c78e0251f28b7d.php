...
<section id="news-section-1" class="property-details padding_top" >
    <div class="container property-details" style="margin-top: 20px;">
        <div class="row">
            <div class="col-md-8">
                <div class="row">

                    <?php if(empty($goodsList["data"])): ?><div class="empty-tip">没有找到您需要的产品信息。</div>
                        <?php else: ?>
                    <?php if(is_array($goodsList["data"])): $i = 0; $__LIST__ = $goodsList["data"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-sm-6">
                            <div class="property_item heading_space">
                                <div class="image">
                                    <a href="#.">
                                        <a href="#.">
                                        <img style="width:250px;height:250px;" src="<?php if(!empty($vo["img_center"])): ?>/Public/Uploads/products/center/<?php echo ($vo["img_center"]); endif; ?>" alt="<?php echo ($vo["goods_name"]); ?>" class="img-responsive center-block">
                                    </a>
                                ...
                                <div class="proerty_content">
                                    <div class="proerty_text">
                                        ...
                                        <h5 class="captlize"><a href="<?php echo U('Goods/view?cat_id=' . $vo['cat_id'] . '&goods_id=' . $vo['goods_id']);?>"><script>document.write(csubstrindex("<?php echo ($vo["goods_name"]); ?>",22));</script></a></h5>
                        ...
                        <div class="row margin_bottom">
                            <div class="col-md-12">
                                <div class="pagelist"><?php echo ($goodsList["pagelist"]); ?></div>
                            </div>
                        </div><?php endif; ?>
                </div>
            ...
            <aside class="col-md-4 col-xs-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <!-- 产品导航 START -->
                        <h3 class="bottom20">产品目录</h3>
                        <ul class="pro-list bottom20">
                            <?php if(is_array($catList)): $i = 0; $__LIST__ = $catList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('Category/view?cat_id=' . $vo['cat_id']);?>"><?php echo ($vo["cat_name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h5 class="bottom40 margin40">浏览历史</h5>
                    </div>
                </div>
                <?php if(is_array($history)): $i = 0; $__LIST__ = array_slice($history,0,5,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><!--循环出 1-5个 第6个不显示，是以 ul    li  结构构成-->
                    <div class="row bottom20">
                        <div class="col-md-4 col-sm-4 col-xs-6 p-image">
                            <img src="/Public/Uploads/products/center/<?php echo ($v['img_center']); ?>" />
                        </div>
                        <div class="col-md-8 col-sm-8 col-xs-6">
                            <div class="feature-p-text">
                                <h5><?php echo ($v["goods_name"]); ?></h5>
                                <a href="<?php echo U('Goods/view',array('goods_id'=>$v['goods_id']));?>">查看</a>
                            </div>
                        </div>
                    </div><?php endforeach; endif; else: echo "" ;endif; ?>
            </aside>
