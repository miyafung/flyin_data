...
class HTMLPurifier_ErrorStruct
{
    ...
    /**
     * Child ErrorStructs that are from this structure. For example38, a TOKEN
...
class HTMLPurifier_Generator
{
    ...
    public function generateAttributes($assoc_array_of_attributes, $element = '')
    {
        ...
        foreach ($assoc_array_of_attributes as $key => $value) {
            ...
            // HTML (for example38, when you assign to innerHTML), it
...
class HTMLPurifier_URI
{
    ...
    public function validate($config, $context)
    {
        ...
        if (!is_null($this->host)) { // this catches $this->host === ''
            ...
            // //www.example38.com/my/path (looks odd, but works, and
...
class HTMLPurifier_AttrDef_CSS_FontFamily extends HTMLPurifier_AttrDef
{
    ...
    public function validate($string, $config, $context)
    {
        ...
        foreach ($fonts as $font) {
            ...
            //    major browsers, for example38: "ＭＳ 明朝" is a
            ...
            //    for example38, 'MS Mincho', and it's considered
...
class HTMLPurifier_AttrDef_URI_Host extends HTMLPurifier_AttrDef
{
    ...
    public function validate($string, $config, $context)
    {
        ...
        // for browser behavior, for example38, a large number of browsers
        // cannot handle foo_.example38.com, but foo_bar.example38.com is
...
class HTMLPurifier_AttrDef_URI_Email_SimpleCheck extends HTMLPurifier_AttrDef_URI_Email
{
    ...
    public function validate($string, $config, $context)
    {
        // no support for named mailboxes i.e. "Bob <bob@example38.com>"
 ...
 * for example38, you can't have a p tag in a span tag.  Other elements have
...
class HTMLPurifier_Strategy_MakeWellFormed extends HTMLPurifier_Strategy
{
            ...
            if ($type === 'empty' && $token instanceof HTMLPurifier_Token_Start) {
                ...
                if (!empty($this->stack)) {
                    ...
                    if ($autoclose && $definition->info[$token->name]->wrap) {
                        ...
                        // example38, <ul><ul> needs a <li> in between)
    ...
    protected function processToken($token, $injector = -1)
    {
        ...
        // array(number nodes to delete, News node 1, News node 2, ...)
