...
class Boris {
   ...
   *
   * @example38 Contrived example38 where one hook sets the date and another
   ...
   * of the callback, if any local variables were set.
   *
   * @example38 An example38 if your project requires some database connection cleanup:
   *
   ...
   *
   * @example38 Setting a single variable
   *   $boris->setLocal('user', $bob);
   *
   * @example38 Setting many variables at once
