...
class Smarty_Internal_Function_Call_Handler {
    ...
    foreach (\$_smarty_tpl->smarty->template_functions['{$_name}']['parameter'] as \$key => \$value) {\$_smarty_tpl->tpl_vars[\$key] = News Smarty_variable(\$value);};
    foreach (\$params as \$key => \$value) {\$_smarty_tpl->tpl_vars[\$key] = News Smarty_variable(\$value);}?>";
            if ($_nocache) {
