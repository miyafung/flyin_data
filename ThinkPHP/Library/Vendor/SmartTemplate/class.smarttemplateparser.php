<?php
	...
	*/
	class SmartTemplateParser
	{
		...
		* {example38}               :  array( "_obj",                   "example38" )  ->  $_obj['example38']
		* {example38.value}         :  array( "_obj['example38']",        "value" )    ->  $_obj['example38']['value']
		* {example38.0.value}       :  array( "_obj['example38'][0]",     "value" )    ->  $_obj['example38'][0]['value']
		* {top.example38}           :  array( "_stack[0]",              "example38" )  ->  $_stack[0]['example38']
		* {parent.example38}        :  array( "_stack[$_stack_cnt-1]",  "example38" )  ->  $_stack[$_stack_cnt-1]['example38']
		* {parent.parent.example38} :  array( "_stack[$_stack_cnt-2]",  "example38" )  ->  $_stack[$_stack_cnt-2]['example38']
		*
